	        ...
	        <div class="row">
	          <div class="input-field col s6">
	            <select id="idLivre" name="idLivre" class="browser-default">
                  ...
                  <c:if test="${!livres_dispo==null }">
                        <c:forEach var="f" items="${livres_dispo}">

                      <option value=""${f.id}">"Titre du livre","${f.auteur}"</option>
                       </c:forEach>
                    </c:if>
	            </select>
	          </div>
	          <div class="input-field col s6">
	            <select id="idMembre" name="idMembre" class="browser-default">
                  ...
                  <c:if test="${!membres_dispo==null }">
                                                                              <c:forEach var="f" items="${membres_dispo}">
