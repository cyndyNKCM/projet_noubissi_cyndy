      ...
      <div class="row">
        <div class="col l4 s6">
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3><%request.getAttribute("NombreDesMembres");%></h3> <!-- TODO : afficher le nombre de membres à la place de 12 -->
              <p>Membres</p>
            </div>
            <div class="icon">
        ...
        <div class="col l4 s6">
          <div class="small-box bg-green">
            <div class="inner">
              <h3><%request.getAttribute("NombreDesLivres");%></h3> <!-- TODO : afficher le nombre de livres à la place de 27 -->
              <p>Livres</p>
            </div>
            <div class="icon">
        ...
        <div class="col l4 s6">
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3><%request.getAttribute("NombreDesEmprunts");%></h3> <!-- TODO : afficher le nombre d'emprunts à la place de 1515 -->
              <p>Emprunts</p>
            </div>
            <div class="icon">
        ...
        <div class="container">
	        <div class="col s12">
	          ...
	          <table class="striped">
                ...
                <c:if test="${!emprunt_list==null }">
                    <c:forEach var="f" items="${emprunt_list}">
                    <tr>
                        <td>${f.livre.titre}, <em>d${f.livre.auteur}</em></td>
                        <td>${f.membre.prenom} ${f.membre.nom}</td>
                        <td>${f.dateEmprunt}</td>
                        <td>
                            <a href="emprunt_return?id=${f.id}"><ion-icon class="table-item" name="log-in"></a>
                        </td>
                    </tr>
