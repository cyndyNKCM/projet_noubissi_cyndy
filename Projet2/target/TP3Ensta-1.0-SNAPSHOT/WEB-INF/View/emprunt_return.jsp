	        ...
	        <div class="row">
	          <div class="input-field col s12">
	            <select id="id" name="id" class="browser-default">
	              ...
	              <c:if test="${!emprunt_return==null }">
                    <c:forEach var="f" items="${emprunt_return}">
                        <option value="${f.id}" selected>"${f.livre.titre}", emprunté par ${f.membre.prenom} ${f.membre.nom}</option>
                      </c:forEach>
                   </c:if>
